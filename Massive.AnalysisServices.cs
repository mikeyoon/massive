...
namespace Massive
{
    public static class ObjectExtensions
    {
        ...
        /// </summary>
        public static void AddParams(this AdomdCommand cmd, params object[] args)
        {
        ...
        public static dynamic RecordToExpando(this IDataReader rdr)
        {
            ...
            for (int i = 0; i < rdr.FieldCount; i++)
                d.Add(rdr.GetName(i).Replace("[", "").Replace("]", "").Replace('.', '_').Replace(" ", ""), DBNull.Value.Equals(rdr[i]) ? null : rdr[i]);
            return e;
        }
        /// <summary>
    ...
    public class DynamicModel : DynamicObject
    {
        ...
        public virtual IEnumerable<dynamic> Query(string sql, AdomdConnection connection, params object[] args)
        {
        ...
        /// </summary>
        public virtual AdomdConnection OpenConnection()
        {
            //var result = _factory.CreateConnection();
            AdomdConnection result = new AdomdConnection(ConnectionString);
            result.Open();
            return result;
        }
        /// <summary>
        ...
        /// </summary>
        public virtual List<AdomdCommand> BuildCommands(params object[] things)
        {
            var commands = new List<AdomdCommand>();
        ...
        public virtual int Execute(AdomdCommand command)
        {
            return Execute(new AdomdCommand[] { command });
        }
        ...
        /// </summary>
        public virtual int Execute(IEnumerable<AdomdCommand> commands)
        {
            var result = 0;
            using (var conn = OpenConnection())
            {
        ...
        public virtual AdomdCommand CreateInsertCommand(dynamic expando)
        {
            AdomdCommand result = null;
        ...
        /// </summary>
        public virtual AdomdCommand CreateUpdateCommand(dynamic expando, object key)
        {
            var settings = (IDictionary<string, object>)expando;
            var sbKeys = new StringBuilder();
        ...
        /// </summary>
        public virtual AdomdCommand CreateDeleteCommand(string where = "", object key = null, params object[] args)
        {
